      ...
      <Container>
        ...
        <Row lg="3" sm="1">
          <Col sm={true} lg={true} className="mt-3">
            <Card onClick={() => setOpen4(!open4)}
              aria-controls="example-collapse-text"
              aria-expanded={open1}>
              <div className="content">
                <div className="content-overlay"></div>
                <Card.Img variant="top" src="https://live.staticflickr.com/65535/51403424917_0fbd56d7fa_b.jpg" style={{
                  maxWidth: '100%',
                  height: '25vw', objectFit: 'contain'
                }} />
                <div className="content-details">
                  <h3 className="content-title">Knolist</h3>
              ...
              <Collapse in={open4}>
                <div>
                  <div style={{ padding: '5%' }}>
                    <a href="http://www.knolist.com">Knolist</a> is an information-structuring and idea-generation app.
                                    <br /> <br />
                    ...
                    <OverlayTrigger placement="bottom" delay={{ show: 90, hide: 90 }} overlay={<Tooltip>MongoDB</Tooltip>}>
                      <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/29/Postgresql_elephant.svg/440px-Postgresql_elephant.svg.png" alt="Postgres logo" style={{ maxWidth: '11%' }} />
                    </OverlayTrigger>
                  </div>
                </div>
              </Collapse>
                ...
                <div>
                  <div style={{ padding: '5%' }}>
                    Spotify Wrapped, but for exposing your Tinder habits.
                                    <br /><br />
                    <a href="https://github.com/leealison/tinder-wrapped">
          ...
          <Col sm={true} lg={true} className="mt-3">
            <Card onClick={() => setOpen1(!open1)}
              ...
              <div className="content">
                <div className="content-overlay"></div>
                <Card.Img variant="top" src="https://pbs.twimg.com/profile_images/943377199784169473/YaCC7nt5.jpg" style={{
                  maxWidth: '100%',
        ...
        <Row lg="3" sm="1">
          <Col sm={true} lg={true} className="mt-3">
            <Card className="card" onClick={() => setOpen2(!open2)}
              ...
              <div className="content">
                <div className="content-overlay"></div>
                <Card.Img variant="top" src="https://live.staticflickr.com/65535/50222590948_9007eec6c2_z.jpg" style={{
                  maxWidth: '100%',
                  height: '25vw', objectFit: 'cover'
                }} />
                <div className="content-details">
          ...
          <Col sm={true} lg={true} className="mt-3">
            <Card className="card" onClick={() => setOpen3(!open3)}
              ...
              <div className="content">
                <div className="content-overlay"></div>
                <Card.Img variant="top" src="https://live.staticflickr.com/65535/50222602823_6ebb8259bb_c.jpg" style={{
                  maxWidth: '100%',
                  height: '25vw', objectFit: 'cover'
                }} />
                <div className="content-details">
